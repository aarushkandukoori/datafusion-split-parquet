-- TPC-DS query 72. TPC-DS is Copyright Transaction Processing Performance Council (TPC).
...
WHERE d1.d_week_seq = d2.d_week_seq
  ...
  AND d3.d_date > d1.d_date + interval '5 days' -- date + interval (DataFusion rejects bare "d1.d_date + 5")
